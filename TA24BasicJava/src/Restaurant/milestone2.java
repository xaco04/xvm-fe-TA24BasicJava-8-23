        ...
        do {
            try {
                ...
                if (opcio >= 1 && opcio <= 5) {
                    ...
                    throw new PlatNoExisteixException("Opció incorrecta. Introduïu un número entre 1 i 5.");
                }
...
class PlatNoExisteixException extends Exception {
    public PlatNoExisteixException(String message) {
        super(message);
    }
}

class SiNoException extends Exception {
